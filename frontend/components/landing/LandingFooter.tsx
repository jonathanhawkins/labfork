...
const footerSections: FooterSection[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Contact", href: "mailto:hello@labfork.com" },
    ...
    <footer className="bg-slate-950 border-t border-white/10">
      ...
      <div className="max-w-6xl mx-auto px-6 py-16 text-center">
        <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
          Ready to Fork Your First Lab?
        </h2>
        <p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto">
          Join 1,000+ researchers using LabFork to discover breakthroughs faster.
        </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
            ...
            <div className="col-span-2 md:col-span-1">
              ...
              <p className="text-sm text-gray-500 mb-4">
                Fork research labs. Watch AI agents work. Collaborate globally.
              </p>
      ...
      <div className="border-t border-white/10 py-6">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-gray-500">
            © 2026 LabFork. Open source under MIT license.
          </p>
