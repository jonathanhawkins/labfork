...
const API_BASE = "/api/demos/pitchflow";

export default function PitchflowDemoPage() {
  ...
  return (
    <div className="min-h-screen bg-background p-8">
      <div className="max-w-2xl mx-auto">
        <DemoBreadcrumb demoId="pitchflow" />
        ...
        <div className="mt-8 text-xs text-muted-foreground">
          <p>Inference: <code className="text-foreground-bright">inference/generate_with_pitchflow.py</code></p>
        </div>
      </div>
    </div>
  );
