...
const API_BASE = "/api/demos/facodec";

export default function FacodecDemoPage() {
    ...
    <div className="min-h-screen bg-background p-8">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mt-8 text-xs text-muted-foreground">
          <p>Inference: <code className="text-foreground-bright">inference/generate_with_facodec.py</code></p>
        </div>
      </div>
    </div>
  );
