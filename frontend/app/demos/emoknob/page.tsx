...
const API_BASE = "/api/demos/emoknob";

export default function EmoknobDemoPage() {
  ...
  return (
    <div className="min-h-screen bg-background p-8">
      <div className="max-w-2xl mx-auto">
        <DemoBreadcrumb demoId="emoknob" />

        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            <div className="p-2 rounded-lg bg-foreground/10">
              <Sliders className="w-5 h-5 text-foreground-bright" />
            </div>
          ...
          <p className="text-muted-foreground">
            Direction vector emotion control with intensity slider
          </p>
        </div>
        ...
        <div className="mt-8 text-xs text-muted-foreground">
          <p>Inference: <code className="text-foreground-bright">inference/generate_with_emoknob.py</code></p>
        </div>
      </div>
    </div>
  );
