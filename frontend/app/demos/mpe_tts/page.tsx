...
const API_BASE = "/api/demos/mpe_tts";

export default function MpettsDemoPage() {
    ...
    <div className="min-h-screen bg-background p-8">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mt-8 text-xs text-muted-foreground">
          <p>Inference: <code className="text-foreground-bright">inference/generate_with_mpe_tts.py</code></p>
        </div>
      </div>
    </div>
  );
