...
const API_BASE = "/api/demos/emo_film";

export default function EmofilmDemoPage() {
  ...
  return (
    <div className="min-h-screen bg-background p-8">
      <div className="max-w-2xl mx-auto">
        <DemoBreadcrumb demoId="emo_film" />
        ...
        <div className="mt-8 text-xs text-muted-foreground">
          <p>Inference: <code className="text-foreground-bright">inference/generate_with_emo_film.py</code></p>
        </div>
      </div>
    </div>
  );
