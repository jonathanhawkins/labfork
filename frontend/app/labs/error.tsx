...
/**
 * Error Boundary for Labs Page
 *
 * Catches and handles errors in the /labs route.
 * Provides user-friendly error UI with recovery options.
 */

import { useEffect } from "react";
import { AlertCircle, RefreshCw, Home, FlaskConical } from "lucide-react";
          ...
          <div className="max-w-md w-full animate-in fade-in-0 slide-in-from-bottom-4 duration-300">
            <div className="bg-card border border-destructive/20 rounded-xl p-6">
              ...
              <p className="text-sm text-muted-foreground mb-6">
                {error.message ||
                  "An unexpected error occurred while loading research labs. Please try again."}
              </p>
