...
/**
 * Error Boundary for Papers Page
 *
 * Catches and handles errors in the /papers route.
          ...
          <div className="max-w-md w-full animate-in fade-in-0 slide-in-from-bottom-4 duration-300">
            <div className="bg-card border border-destructive/20 rounded-xl p-6">
              ...
              <p className="text-sm text-muted-foreground mb-6">
                {error.message ||
                  "An unexpected error occurred while loading the papers queue. Please try again."}
              </p>
