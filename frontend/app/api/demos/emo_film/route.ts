...
const INFERENCE_SCRIPT = "inference/generate_with_emo_film.py";
const OUTPUT_DIR = "public/generated";

interface GenerateRequest {
  text: string | number; emotion: string | number; intensity: string | number;
}
...
export async function POST(request: NextRequest) {
  try {
    ...
    const outputFilename = `emo_film_${outputId}.wav`;
    ...
    console.error("emo_film API error:", error);
    return NextResponse.json(
