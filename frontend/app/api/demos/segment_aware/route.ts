...
const INFERENCE_SCRIPT = "inference/generate_with_segment_aware.py";
...
export async function POST(request: NextRequest) {
  try {
    ...
    const outputFilename = `segment_aware_${outputId}.wav`;
    ...
    console.error("segment_aware API error:", error);
    return NextResponse.json(
