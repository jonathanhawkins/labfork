...
const INFERENCE_SCRIPT = "inference/generate_with_spherical.py";
const OUTPUT_DIR = "public/generated";

interface GenerateRequest {
  text: string | number; emotion: string | number; intensity: string | number; interpolate: string | number; vad: string | number;
}
...
export async function POST(request: NextRequest) {
  try {
    ...
    const outputFilename = `spherical_${outputId}.wav`;
    ...
    console.error("spherical API error:", error);
    return NextResponse.json(
