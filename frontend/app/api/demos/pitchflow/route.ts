...
const INFERENCE_SCRIPT = "inference/generate_with_pitchflow.py";
const OUTPUT_DIR = "public/generated";

interface GenerateRequest {
  text: string | number; temperature: string | number;
}
...
export async function POST(request: NextRequest) {
  try {
    ...
    const outputFilename = `pitchflow_${outputId}.wav`;
    ...
    console.error("pitchflow API error:", error);
    return NextResponse.json(
