...
const INFERENCE_SCRIPT = "inference/generate_with_mismatch_aware.py";
const OUTPUT_DIR = "public/generated";

interface GenerateRequest {
  text: string | number; emotion: string | number; vad: string | number; test: string | number;
}
...
export async function POST(request: NextRequest) {
  try {
    ...
    const outputFilename = `mismatch_aware_${outputId}.wav`;
    ...
    console.error("mismatch_aware API error:", error);
    return NextResponse.json(
