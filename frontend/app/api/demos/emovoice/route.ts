...
const INFERENCE_SCRIPT = "inference/generate_with_emovoice.py";
const OUTPUT_DIR = "public/generated";

interface GenerateRequest {
  text: string | number; emotion: string | number; intensity: string | number; interpolate: string | number;
}
...
export async function POST(request: NextRequest) {
  try {
    ...
    const outputFilename = `emovoice_${outputId}.wav`;
    ...
    console.error("emovoice API error:", error);
    return NextResponse.json(
